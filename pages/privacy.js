...
export default function privacy() {
  return (
    <div className="bg-[rgb(0,0,0)] text-white text-sm p-5">
      <h1>Privacy Policy for comparetoday.nl</h1>

      <p>
        At Compare Today, accessible from comparetoday.nl, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Compare
      ...
      <p>
        comparetoday.nl legal basis for collecting and using the personal
      ...
      <ul>
        <li>comparetoday.nl needs to perform a contract with you</li>
        <li>You have given comparetoday.nl permission to do so</li>
        <li>
          Processing your personal information is in comparetoday.nl legitimate
          interests
        </li>
        <li>comparetoday.nl needs to comply with the law</li>
      </ul>

      <p>
        comparetoday.nl will retain your personal information only for as long
      ...
      <p>
        Compare Today follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of Compare Today.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Compare Today, which are sent
      ...
      <p>
        Note that Compare Today has no access to or control over these cookies
      ...
      <p>
        Compare Today's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Compare Today does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Compare Today. This policy is not applicable to
